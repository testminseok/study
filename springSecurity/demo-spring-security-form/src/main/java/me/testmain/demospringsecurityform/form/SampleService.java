...
public class SampleService {
    ...
    /*
     * @Secured("ROLE_USER") - 메소드 접근 전 권한확인
     * @RolesAllowed("ROLE_USER") - 메소드 접근 전 권한확인
     * @PreAuthorize("hasRole('USER')") - 메소드 접근 전 권한확인 & Spring Expression Language 를 지원하여 파라미터 값 확인가능
     * @PostAuthorize("returnObject") - 메소드 접근 후 return data 에 returnObject 라는 필드로 접근가능
     *                                  Spring Expression Language 를 지원
     * */
    @Secured("ROLE_USER")
